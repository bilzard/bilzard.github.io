...
2025年1月22日に公開されたDeepSeek-R1の論文、および関連研究を適宜参照しながら、
強化学習とSFTの線引きが曖昧になってきたという話をします。
後半ではDeepDeek-R1が高いベンチマーク性能を実現した要因について考察します。
...
前置きが長くなりましたが、本記事の内容である「DeepSeek-R1ではSFTとRLは区別が曖昧である」という話をします。
...
以上で示したように、DeepSeek-R1では学習するモデルがpolicyモデルのみなので、実質的にRLフェーズでやっていることはSFTとほとんど変わらなくなりました。
...
以上、DeepSeek-R1に至るまでのRL目的関数の発展を確認しながら、
「RLと言いつつもやっていることはSFTとほとんど変わらない」という話をしました。
